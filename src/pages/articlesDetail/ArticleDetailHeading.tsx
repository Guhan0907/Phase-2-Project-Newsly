// import { Typography, Stack, Chip, useTheme, useMediaQuery, Box, Divider } from "@mui/material";
...
//         {section && <Chip label={section} color="primary" />}
//         {subsection && <Chip label={subsection} color="secondary" />}
//       </Stack>
//     )}
//   </>
// );
